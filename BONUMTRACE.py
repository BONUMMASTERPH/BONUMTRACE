...
def dtect():
	print("  BONUMTRACE ")
	print(" Sub-domain ScanningPort Scanning Wordpress Scanning Wordpress ")
	print(" Username Enumeration Wordpress Backup Grabbing Sensitive File ")
	print(" DetectionSame-Site Scripting Scanning Mag-click sa Jacking Detection  ")
	print(" Powerful XSS kahinaan sa pag-scanSQL Injection kahinaan sa pag-scanUser-Friendly")
	print("") 
	print(" BONUMTRACE -PENTEST BY BONUMMAATER")
	print(" UNDERGROUND SECURITY PH  ENJOY! ")
	print("")
	def menu():
